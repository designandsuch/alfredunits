...
class Units #0
{
   ...
   *
	...
	//$this->add_to_lib(1,0,'lea'		,'length'				,'|lea|league|'										,'league'				  ,'League'					,'km|mi'										 	); 
		...
		$this->add_to_lib(1,0,'mxn'	,'currency'		,'|mxn|mex$|peso|mexican'							,'Mexican peso'						,'Mexican peso' 									,'usd|eur|gbp'); 
		...
		$this->add_to_lib(1,0,'nzd'	,'currency'		,'|nzd|wiki|nz$|new zealand|dollar'		,'New Zealand dollar'			,'New Zealand dollar' 						,'usd|eur|gbp'); 
